...
-- confirming above sales
SELECT SUM(sales_amount) AS 'Total Sales' -- for 2019
FROM transactions
WHERE sales_amount NOT BETWEEN -1 AND 0
AND market_code = 'Mark002'
AND order_date BETWEEN '2019-01-01' AND '2019-12-31'; -- 52007487
SELECT SUM(sales_amount) AS 'Total Sales' -- for 2020
FROM transactions
WHERE sales_amount NOT BETWEEN -1 AND 0
AND market_code = 'Mark002'
AND order_date BETWEEN '2020-01-01' AND '2020-12-31'; -- 20183077
SELECT SUM(52007487+20183077); -- 72190564
